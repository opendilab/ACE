...
class MAPPO(nn.Module):
    ...
    def __init__(
        ...
        #     agent_obs_shape, encoder_hidden_size_list[:-1]+[actor_head_hidden_size,], activation=activation, norm_type=norm_type
        # )
        # self.critic_encoder = global_encoder_cls(
        #     global_obs_shape, encoder_hidden_size_list[:-1]+[critic_head_hidden_size,], activation=activation, norm_type=norm_type
        # )

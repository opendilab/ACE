...
from .ace_dqn import SMACACEDQNPolicy
...
@POLICY_REGISTRY.register('smac_ace_dqn_command')
class SMACACEDQNCommandModePolicy(SMACACEDQNPolicy, EpsCommandModePolicy):
    pass
